...
<body>
    ...
    <div class="page">
        ...
        <table class="redemption-summary">
            ...
            @if(($overdueInterest ?? 0) > 0 || ($redemption->transfer_amount ?? 0) > 0)
            <tr>
                @if(($overdueInterest ?? 0) > 0)
                    <td class="rs-label">Faedah Lewat / Overdue :</td>
                    <td class="rs-value">RM {{ number_format($overdueInterest, 2) }}</td>
                @else
                    <td class="rs-label"></td>
                    <td class="rs-value"></td>
                @endif

                @if(($redemption->transfer_amount ?? 0) > 0)
