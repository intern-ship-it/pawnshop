...
Route::get('/preview/renewal-receipt/{renewal}', function (\App\Models\Renewal $renewal) {
    $renewal->load([
        'pledge.customer',
    ...
    return view('pdf.renewal-receipt-preprinted', [
        'renewal' => $renewal,
        'copy_type' => request('copy_type', 'customer'),
        'settings' => $settings,
        'printed_at' => now(),
...
Route::middleware('auth:sanctum')->group(function () {
     ...
     */
        Route::prefix('gold-prices')->group(
            function () {
            // Basic Operations
        ...
        // Pledges
        Route::prefix('pledges')->group(
            function () {
            // View permissions
            Route::middleware('check.permission:pledges,view')->group(
                function () {
            ...
            // Print permissions
            Route::middleware('check.permission:pledges,print')->group(
                function () {
        ...
        Route::prefix('renewals')->group(
            ...
            // WhatsApp
            Route::post('/{renewal}/send-whatsapp', [RenewalController::class , 'sendWhatsApp'])
                ->middleware('check.permission:whatsapp,send');
        }
        );
        ...
        Route::prefix('redemptions')->group(
            ...
            // WhatsApp
            Route::post('/{redemption}/send-whatsapp', [RedemptionController::class , 'sendWhatsApp'])
                ->middleware('check.permission:whatsapp,send');
        }
        );
        ...
        Route::prefix('inventory')->group(
            function () {
            // View permissions
            Route::middleware('check.permission:inventory,view')->group(
                function () {
            ...
            Route::middleware('check.permission:inventory,update_location')->group(
                function () {
        ...
        Route::prefix('storage')->group(
            function () {
            // View permissions
            Route::middleware('check.permission:storage,view')->group(
                function () {
            ...
            Route::middleware('check.permission:storage,manage')->group(
                function () {
        ...
        // Reconciliation
        Route::prefix('reconciliations')->group(
            function () {
            // View permissions
            ...
            // Complete permission
            Route::middleware('check.permission:reconciliation,complete')->group(
                function () {
        ...
        // Reports
        Route::prefix('reports')->middleware('check.permission:reports,view')->group(
            function () {
        ...
        // Day End
        Route::prefix('day-end')->group(
            function () {
            // View permissions
            Route::middleware('check.permission:dayend,view')->group(
                function () {
        ...
        Route::prefix('settings')->group(
            function () {
            // View permissions
            Route::middleware('check.permission:settings,view')->group(
                function () {
        ...
        Route::prefix('users')->group(
            ...
            Route::middleware('check.permission:users,edit')->group(
                function () {
        ...
        Route::prefix('whatsapp')->group(
            function () {
            // View permissions
            Route::middleware('check.permission:whatsapp,view')->group(
                function () {
                Route::get('/config', [WhatsAppController::class , 'config']);
                Route::get('/templates', [WhatsAppController::class , 'templates']);
                Route::get('/gateway-templates', [WhatsAppController::class , 'gatewayTemplates']);
            ...
            Route::middleware('check.permission:whatsapp,configure')->group(
                function () {
            ...
            // Send permission
            Route::middleware('check.permission:whatsapp,send')->group(
                function () {
        ...
        Route::prefix('hardware')->group(
            ...
            // Edit permissions
            Route::middleware('check.permission:settings,edit')->group(
                function () {
        ...
        Route::prefix('print')->group(
            ...
            Route::prefix('dot-matrix')->group(
                ...
                Route::post('/pre-printed-a4/pledge/{pledge}', [DotMatrixPrintController::class , 'prePrintedPledgeReceiptA4'])
                    ->middleware('check.permission:pledges,print');
                ...
                Route::post('/pre-printed-with-form/renewal/{renewal}', [DotMatrixPrintController::class , 'prePrintedRenewalReceiptWithForm'])
                    ->middleware('check.permission:renewals,print');
                Route::post('/pre-printed-with-form/renewal/{renewal}/reprint', [DotMatrixPrintController::class , 'prePrintedRenewalReceiptWithFormReprint'])
                    ->middleware('check.permission:renewals,print');
            ...
            // Barcode print
            Route::middleware('check.permission:inventory,print_barcode')->group(
                function () {
