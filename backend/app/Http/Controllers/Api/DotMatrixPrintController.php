...
HTML;
    ...
    /**
     * Generate Pledge Receipt WITH Pre-Printed Form Template (REPRINT)
     * Returns the complete form with "(REPRINT)" text on the copies
     */
    public function prePrintedPledgeReceiptWithFormReprint(Request $request, Pledge $pledge): JsonResponse
    {
        try {
            if ($pledge->branch_id !== $request->user()->branch_id) {
                return $this->error('Unauthorized', 403);
...
HTML;
            ...
            \Log::error('Pre-Printed With Form Reprint Error: ' . $e->getMessage());
            return $this->error('Print error: ' . $e->getMessage(), 500);
        }
    }
    ...
    public function prePrintedRedemptionReceipt(Request $request, $redemption): JsonResponse
    {
        try {
            ...
            return $this->success([
                ...
                'orientation' => 'landscape',
                'format' => 'html',
                'paper_size' => 'A5 Landscape (210mm x 148mm)',
                'type' => 'pre_printed_overlay_a5',
            ]);
...
<div class="ppo-page">
    ...
    <!-- FINANCIAL ROW 1: Principal | Total Redemption -->
    <!-- <div class="ppo-fin-row ppo-fin-row1">
        <div class="ppo-fin-col-left">Pinjaman / Principal : RM {$principalFormatted}</div>
        <div class="ppo-fin-col-right">JUMLAH TEBUSAN / TOTAL REDEMPTION : RM {$totalPaidFormatted}</div>
    </div> -->

    <!-- FINANCIAL ROW 2: Interest | Cash -->
    <!-- <div class="ppo-fin-row ppo-fin-row2">
        <div class="ppo-fin-col-left">Faedah / Interest : RM {$interestFormatted}</div>
        <div class="ppo-fin-col-right">Bayaran Tunai / Cash : RM {$totalPaidFormatted}</div>
    </div> -->
    ...
    <!-- DATES -->
    <!-- <div class="ppo-pledge-date-label">Tarikh Pajakan / Pledge Date</div>
    <div class="ppo-pledge-date">{$pledgeDate->format('d/m/Y')}</div> -->
    <!-- <div class="ppo-redemption-date-label">Tarikh Tebusan / Redemption Date</div> -->
